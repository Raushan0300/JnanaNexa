...
const ImageH = () => {
  ...
  return (
    ...
    borderRadius:12, color:'#FFFDD0', paddingVertical:5, width:'100%', textAlign:'center', justifyContent:'center', marginTop:-30}}>(DALL-E-3)</Text>
      ...
      {image ? (
        <Image style={{width:256, height:256, resizeMode:'cover', marginTop:20}}
        source={image} contentFit='cover'
        transition={1000}/>
      ):null}
